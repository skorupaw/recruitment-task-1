...
export const MoodSaveSuccessModal = memo<SaveMoodsDialogProps>(({ isOpen, onChangeOpen }) => {
  return (
    <Dialog open={isOpen} onOpenChange={onChangeOpen}>
      <DialogContent>
        ...
        <div className="space-y-2 text-center">
          <DialogTitle className="text-foreground text-2xl font-bold">Congratulations!</DialogTitle>
