...
- [ ] Disable navigation buttons when user reach the first and the last page, this can be achieved using `isPreviousDisabled` and `isNextDisabled` from [`Navigation`](./src/ui/Navigation.tsx) component.
